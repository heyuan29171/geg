...
EMOJI_EN = {
  ...
  '⚗️': 'alembic flask', '💎': 'gem', '🌸': 'cherry blossom', '❄️': 'snowflake',
  '🍎': 'apple', '🫘': 'bean seeds', '🪴': 'potted sprout', '🍃': 'leaf',
  '🌵': 'cactus', '🎋': 'bamboo stalk', '🌰': 'pinecone', '🦊': 'fox',
  '🦉': 'owl', '🎍': 'potted bamboo', '🌿': 'moss and vines', '🌼': 'dandelion flower',
  '🧿': 'evil eye charm', '🌫️': 'fog', '🌨️': 'snow flurry', '🌊': 'ocean wave',
  '🐊': 'crocodile', '🦀': 'crab', '💦': 'water droplets', '🐼': 'panda',
  '🦣': 'mammoth', '⛲': 'waterfall fountain', '📖': 'book', '🐋': 'whale',
  '🦌': 'deer', '🐍': 'snake', '🐡': 'pufferfish', '⚒️': 'hammer',
  '🧜': 'mermaid', '🎩': 'top hat', '🔭': 'telescope', '🦾': 'robot arm',
  '🗡️': 'dagger', '🦎': 'gecko', '🐑': 'sheep', '🪓': 'axe', '🐸': 'frog',
  '🧝': 'elf', '🌙': 'crescent moon', '🐳': 'whale', '🌅': 'sunrise',
  '🪶': 'feather', '🦢': 'swan', '⭐': 'star', '⛏️': 'pickaxe',
  '🐯': 'tiger', '🧪': 'alchemist flask', '⚜️': 'fleur de lis emblem', '🐆': 'leopard',
  '🦩': 'flamingo crane', '🗿': 'stone statue', '🦅': 'eagle', '🦚': 'peacock phoenix',
  '🦄': 'unicorn qilin', '🦐': 'shrimp', '🐎': 'horse', '🪐': 'ringed planet',
  '🐄': 'cow', '📜': 'royal scroll', '🔮': 'crystal ball', '🪄': 'magic wand',
  '⚱️': 'funeral urn', '🤖': 'robot', '💥': 'explosion', '👽': 'alien',
  '🌾': 'wheat stalk', '🐈': 'cat', '🦝': 'raccoon', '🦖': 't rex',
  '🪝': 'hook', '🦤': 'dodo bird', '🎒': 'sack of calamities', '🐝': 'bee',
  '🧛': 'vampire', '🐹': 'hamster', '🥀': 'withered blood flower', '👁️': 'single eye',
  '⛄': 'snowman', '🦆': 'duck', '🦴': 'bone', '🐗': 'wild boar',
  '🦕': 'ancient sauropod', '🪸': 'coral', '🐨': 'koala', '⚔️': 'crossed swords',
  '🌺': 'hibiscus flower', '🦦': 'otter', '🦗': 'cricket', '📿': 'prayer beads',
  '🧊': 'ice block', '🦑': 'squid', '🗝️': 'old key', '🐂': 'ox',
  '🐰': 'rabbit', '🦫': 'beaver', '⚖️': 'balance scale',
}
EGG_EN = {
